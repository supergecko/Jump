...
Object.assign(Game.prototype, {
  ...
  createCube: function (){
    ...
    var color = cubeType === 'cube' ? this.config.cubeColor : this.config.cubeColor;
    ...
    if (this.jumper.position.y >= this.config.jumpHeight / 2){
      ...
      if (type === 1){
        ...
        // 成功降落
		 ...
		 //成功了
		 if(this.score==1){
			 if (this.succeseCallback) {
			   setTimeout(function(){
			     self.succeseCallback(self.score);
			   }, 1000);
			 }
		 }
         this.xspeed = 0;
